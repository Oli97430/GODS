...
### Changed
- **Smart-plug fan** now switches **ON instantly at take-off** (no delay) and also turns **ON during a fast fall / dive** — you feel the wind build before the impact, not just during steady flight.
