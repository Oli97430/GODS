...
const __time_of_day_script: String = "res://addons/sky_3d/src/Sky3DTimeOfDay.gd"
...
func _enter_tree() -> void:
	...
	add_custom_type("Sky3DTimeOfDay", "Node", load(__time_of_day_script), load(__time_of_day_icon))


func _exit_tree() -> void:
	remove_custom_type("Sky3D")
	remove_custom_type("SkyDome")
	remove_custom_type("Sky3DTimeOfDay")
