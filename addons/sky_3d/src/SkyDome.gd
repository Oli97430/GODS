...
## Celestial North Pole direction, set by [Sky3DTimeOfDay] based on observer latitude.
...
## [member Sky3DTimeOfDay.update_interval] timer. Cloud movement is updated by this method: your choice of
...
## [b][u]Usage[/u][/b][br]
## 1. Set the date and time in [Sky3DTimeOfDay] to 20 March 2025 at midnight (0 hours), and the UTC to zero (0).[br]
## 2. Set the location in Sky3DTimeOfDay to 90° North Latitude and 0° Longitude.[br]
